...
class CustomUser(AbstractUser):
    ...
    username = models.CharField(help_text = '', max_length=150, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator()], verbose_name='username', primary_key = True)
